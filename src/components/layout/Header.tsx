    ...
    <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 relative z-20">
      ...
      <div className="flex items-center gap-2 bg-white/50 dark:bg-slate-900/50 p-2 rounded-3xl border border-white dark:border-slate-800 backdrop-blur-md shadow-sm">
        <button
          ...
          className={`p-3 rounded-2xl transition-all ${accessMode === 'default' ? 'bg-cyan-500 text-white shadow-lg shadow-cyan-500/30' : 'text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
          title="Default Mode"
        >
          <Waves size={20} />
        </button>
        <button
          ...
          className={`p-3 rounded-2xl transition-all ${accessMode === 'colorblind' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/30' : 'text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
        ...
        <button
          ...
          className={`p-3 rounded-2xl transition-all ${accessMode === 'tropical' ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
          title="Tropical Mode"
        >
          <Palmtree size={20} />
        </button>
        ...
        <button
          onClick={toggleTheme}
          className="p-3 rounded-2xl text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all"
        >
